...
const HaggisinJapanCherryBlossomTourDetails = () => {
  return (
    <section className="py-20 bg-[#f4f0eb]">
      <div className="japan-container">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-medium text-japan-indigo mb-4">Cherry Blossom Tour Overview</h2>
          <p className="section-subtitle mx-auto max-w-3xl text-japan-slate">
            Explore Japan's best destinations during cherry blossom season with a unique balance of must-see highlights and 
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="space-y-1 ml-5 list-disc text-gray-700">
                      ...
                      <li>Special cherry blossom viewing spots</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 ml-5 list-disc text-gray-700">
                      ...
                      <li>Cherry blossom viewing at Maruyama Park</li>
                    </ul>
                  </div>
...
export default HaggisinJapanCherryBlossomTourDetails;
