        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch mb-12">
            ...
            <div className="bg-[#002e3e] p-8 rounded-xl shadow-md text-white flex flex-col">
              ...
              <div className="mb-6">
                <p className="text-lg font-medium text-white/95 border-t border-white/20 pt-4"><span className="font-bold">Deposit today:</span> £440 GBP</p>
              </div>
          ...
          <div className="text-center text-gray-500 text-sm max-w-2xl mx-auto">
            ...
            <p>A £440 deposit secures your place on this unforgettable journey.</p>
          </div>
        </div>
      </div>
    </section>
