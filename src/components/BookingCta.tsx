...
const BookingCta = ({ onBookNow, checkoutProvider = "WooCommerce" }: BookingCtaProps) => {
  return (
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-700 text-lg max-w-2xl mx-auto">
              Book your spot now on this exclusive Japan tour with Laura from @OurTravelTreats. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch mb-12">
            <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100 flex flex-col">
              ...
              <ul className="space-y-4 flex-grow">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-japan-green mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Flexible payment plan (only £400 deposit)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-japan-green mt-0.5 flex-shrink-0" />
                  <span className="text-gray-700">Travel with Laura from @OurTravelTreats</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-japan-green mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-[#002e3e] p-8 rounded-xl shadow-md text-white flex flex-col">
              ...
              <div className="text-white/90 text-sm mb-2"><span className="font-medium">Group size:</span> Max 15 travelers</div>
              <div className="text-white/90 text-sm mb-6">
                <span className="font-medium">Start:</span> Tokyo • <span className="font-medium">Finish:</span> Hiroshima
              </div>
              
              <div className="mb-6 flex-grow">
                <div className="text-3xl font-medium">£2,000 <span className="text-3xl text-white">GBP</span></div>
              ...
              <div className="mb-6">
                <p className="text-lg font-medium text-white/95 border-t border-white/20 pt-4">
                  <span className="font-bold">Deposit today:</span> £400 GBP
              ...
              <div className="mt-4 text-center text-white/70 text-sm">
                <p>Secure payment via {checkoutProvider}</p>
                <p className="mt-2">
                  <a 
          ...
          <div className="text-center text-gray-500 text-sm max-w-2xl mx-auto">
            ...
            <p>A £400 deposit (20% non-refundable) secures your place on this unforgettable journey.</p>
          </div>
        </div>
      </div>
    </section>
