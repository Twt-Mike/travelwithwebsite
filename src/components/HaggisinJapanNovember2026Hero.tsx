    ...
    <div className="relative min-h-[60vh] flex items-center justify-center bg-japan-indigo overflow-hidden">
      ...
      <div className="japan-container z-10 pt-16 md:pt-20 pb-12 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="py-3 px-4 mb-4 inline-block rounded-md" style={{ backgroundColor: 'rgba(59, 130, 246, 0.6)' }}>
          ...
          <div className="mb-6">
            <p className="text-white mt-2 font-bold text-base bg-black/40 inline-block px-4 py-2 rounded-md drop-shadow-[0_3px_6px_rgba(0,0,0,0.8)]">
